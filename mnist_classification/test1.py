...
def test_check_dL_db():
    ...
    for _ in range(20):
        ...
        print("shape:", dL_db.shape)
        print("what it should be:", dL_db_true.shape)

        print("dL_dz:", dL_dz)
        print("dz_db:", dz_db)
        
        print("dL_db analytical:", dL_db)
        print("dL_db numerical:", dL_db_true)
        print("difference:", dL_db - dL_db_true)
